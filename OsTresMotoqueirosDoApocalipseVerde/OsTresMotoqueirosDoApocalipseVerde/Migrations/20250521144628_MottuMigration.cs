    ...
    public partial class MottuMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_DADOS = table.Column<int>(type: "NUMBER(10)", maxLength: 15, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSituacao = table.Column<int>(type: "NUMBER(10)", maxLength: 14, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_MOTORISTA = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdEndereco = table.Column<int>(type: "NUMBER(10)", maxLength: 20, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ...
                    FilialIdFilial = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdFilial = table.Column<int>(type: "NUMBER(10)", maxLength: 17, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    NomeFilial = table.Column<string>(type: "NVARCHAR2(150)", maxLength: 150, nullable: false),
                    ResponsavelId = table.Column<int>(type: "NUMBER(10)", maxLength: 7, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPatio = table.Column<int>(type: "NUMBER(10)", maxLength: 30, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSetor = table.Column<int>(type: "NUMBER(10)", maxLength: 17, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ...
                    AreaSetor = table.Column<int>(type: "NUMBER(10)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdMoto = table.Column<int>(type: "NUMBER(10)", maxLength: 16, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ...
                    intitude = table.Column<float>(type: "BINARY_FLOAT", maxLength: 5, nullable: false),
                    ...
                    ModeloIdModelo = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    SetorIdSetor = table.Column<int>(type: "NUMBER(10)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MotosIdMoto = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    SituacoesIdSituacao = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
